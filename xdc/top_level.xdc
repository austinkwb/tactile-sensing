...
##IO Voltage
set_property CONFIG_VOLTAGE 3.3 [current_design]; #Output voltage on IO pins
...
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { jc_cs }]; #IO_L6P_T0_35 Sch=jc[7]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { jc_adc_read_d0 }]; #IO_L22P_T3_35 Sch=jc[8]
# set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { jc_adc_read_d1 }]; #IO_L21P_T3_DQS_35 Sch=jc[9]
set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS33 } [get_ports { jc_clk }]; #IO_L5P_T0_AD13P_35 Sch=jc[10]
